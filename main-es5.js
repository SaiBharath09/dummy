...
var AccessWalletComponent = /** @class */ (function () {
    ...
    AccessWalletComponent.prototype.openNetworkData = function () {
        var dialogRef = this.dialog.open(ChooseNetwork, {
            width: '500px'
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log('The dialog was closed');
...
var ChooseNetwork = /** @class */ (function () {
    function ChooseNetwork(apiServices, dialogRef, data) {
        this.apiServices = apiServices;
    ...
    ChooseNetwork.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    ChooseNetwork.prototype.saveNetType = function (form) {
        this.onNoClick();
...
/* harmony import */ var ng5_slider__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ng5-slider */ "./node_modules/ng5-slider/esm5/ng5-slider.js");
...
var AppConstants = /** @class */ (function () {
    ...
    Object.defineProperty(AppConstants, "serverURL", {
        get: function () { return 'http://myprivatewallet.net/'; },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(AppConstants, "localURL", {
        get: function () { return 'http://e515b781.ngrok.io/'; },
        enumerable: true,
        configurable: true
    });
    ;
...
var CreateWalletComponent = /** @class */ (function () {
    ...
    CreateWalletComponent.prototype.openNetworkData = function () {
        var _this = this;
...
var DialogOverviewExampleDialog = /** @class */ (function () {
    function DialogOverviewExampleDialog(apiServices, dialogRef, data, router) {
        this.apiServices = apiServices;
        this.dialogRef = dialogRef;
        this.data = data;
        this.router = router;
    ...
    DialogOverviewExampleDialog.prototype.saveNetType = function (form) {
        var _this = this;
        this.onNoClick();
        var network = form.value.network;
        sessionStorage.setItem('network', network);
...
var HeaderInner = /** @class */ (function () {
    function HeaderInner(apiServices) {
        this.apiServices = apiServices;
    }
    ...
    WalletBalanceComponent.prototype.refreshBalance = function () {
        ...
        this.apiServices.getBalance().subscribe(function (res) {
            if (res['status']) {
                ...
                _this.apiServices.clearMessage();
                _this.apiServices.sendTextMessage('Balance updated', "success");
            }
            else {
                // set error message
                _this.apiServices.clearMessage();
                _this.apiServices.sendTextMessage('Balance not updated', "danger");
            }
        });
    };
...
var ApiServices = /** @class */ (function () {
    function ApiServices(http, router) {
        this.http = http;
        this.router = router;
        this.display = 'none';
        this.create_wallet = true;
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.verifyCreateWallet(params).subscribe(function (data) {
                if (data['status']) {
                    ...
                    _this.clearMessage();
                    _this.sendTextMessage(data['message'], 'success');
                    ...
                    _this.clearMessage();
                    _this.sendTextMessage(data['message'], 'danger');
                }
    ...
    ApiServices.prototype.importWithWif = function (form) {
        ...
        this.importWallet(params).subscribe(function (data) {
            if (data['status']) {
                _this.clearMessage();
                _this.sendTextMessage(data['data'], 'success');
                _this.setSessionStorage('login_data', data['data']);
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.clearMessage();
                _this.sendTextMessage(data['data'], 'danger');
            }
        });
    };
...
var WalletDashboardComponent = /** @class */ (function () {
    ...
    WalletDashboardComponent.prototype.getFeeDetails = function () {
        var _this = this;
        this.apiServices.getFeeDetails().subscribe(function (res) {
            console.log(res);
            if (res['status']) {
                console.log("Fee details");
                console.log(res['data']);
                _this.fee_details = res['data'];
                _this.value = _this.fee_details['4'];
                _this.options.floor = _this.fee_details['15'];
                _this.options.ceil = _this.fee_details['1'];
            }
            else {
                // set error message
                _this.apiServices.clearMessage();
                _this.apiServices.sendTextMessage("Fee details not found", "danger");
            }
        });
    };
    ...
    WalletDashboardComponent.prototype.transferBTC = function (form) {
        ...
        this.apiServices.transferFunds(params).subscribe(function (res) {
            ...
            if (res['status']) {
                ...
                _this.apiServices.clearMessage();
                _this.apiServices.sendTextMessage("Transfer initiated  " + res['data']['txnHash'], "success");
            }
            else {
                // show faailure msg popup
                _this.apiServices.clearMessage();
                _this.apiServices.sendTextMessage("Transfer Failed", "danger");
            }
        });
    };
